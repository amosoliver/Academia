...
@section('main')
    <div class="container border mt-5 ">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                {{ Form::label('id_aluno', 'Alunos', ['class' => 'control-label col-md-3 col-lg-2']) }}
                {{ Form::select('id_aluno', ['' => 'Selecione um aluno'] + $alunos, null, ['class' => 'form-select']) }}
                {!! $errors->first('id_aluno') !!}
            </div>
            <div class="form-group">
